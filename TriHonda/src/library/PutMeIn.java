...
//FileInputStream fi = new FileInputStream("/home/ewillis/workspace/TriHondaScripts/TriHonda/lib/info.xls");
...
FileUtils.copyFile(scrFile1, new File("Y://Screenshots/" +   "/" + row + "-" + timeStamp + "-" + "hondacar.png"));
...
FileUtils.copyFile(scrFile2, new File("Y://Screenshots/VehicleSubmission/PutMeIn/" + timeStamp +   "/" + row + "-" + timeStamp + "-" + "success.png"));
